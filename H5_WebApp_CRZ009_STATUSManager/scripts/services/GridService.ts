module h5.application {
    ...
    export class GridService {
        ...
        public clearGridStates() {
            let gridIds = ["sampleGrid1", "STATUSListGrid", "customerMasterListGrid", "itemGroupListGrid"]; //added
        ...
        public getSTATUSListGrid(): IUIGrid {
            let STATUSListGrid: IUIGrid = angular.copy(this.baseGrid);
            let gridLinkCellTemplate = "<div class=\"ui-grid-cell-contents\"><span class=\"h5-link\" ng-click=\"grid.appScope.STATUSModule.loadSTATUSRecordModule(col.field, row.entity)\" title=\"Constants\" >{{COL_FIELD CUSTOM_FILTERS}}</span></div>";
