    ...
    (function (application) {
        var GridService = (function () {
            ...
            GridService.prototype.clearGridStates = function () {
                var _this = this;
                var gridIds = ["sampleGrid1", "STATUSListGrid", "customerMasterListGrid", "itemGroupListGrid"];
            ...
            GridService.prototype.getSTATUSListGrid = function () {
                var STATUSListGrid = angular.copy(this.baseGrid);
                var gridLinkCellTemplate = "<div class=\"ui-grid-cell-contents\"><span class=\"h5-link\" ng-click=\"grid.appScope.STATUSModule.loadSTATUSRecordModule(col.field, row.entity)\" title=\"Constants\" >{{COL_FIELD CUSTOM_FILTERS}}</span></div>";
                STATUSListGrid.columnDefs = [
                    { name: "PK01", displayName: this.languageService.languageConstants.get('Constant'), cellTemplate: gridLinkCellTemplate, enableCellEdit: false },
                    { name: "PK03", displayName: this.languageService.languageConstants.get('Key Value'), headerCellClass: "text-left", cellClass: "text-left", enableCellEdit: false },
                ...
                STATUSListGrid.exporterCsvFilename = "sample_list.csv";
                STATUSListGrid.exporterPdfFilename = "sample_list.pdf";
                STATUSListGrid.saveSelection = false;
                return STATUSListGrid;
            };
