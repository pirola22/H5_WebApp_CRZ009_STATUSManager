...
module h5.application {
    ...
    export class AppController {
        ...
        */
        ...
        /**
        * Initialize the STATUS Master module
        */
        private initSTATUSModule() {
        ...
        */
        private initScopeFunctions() {
            ...
            this.scope.STATUSModule.loadSTATUSRecordModule = (fieldName, rowEntity) => { this.displayDetailScreen(fieldName, rowEntity); }
        }
        ...
        */
        private initUIGridsOnRegisterApi() {
            this.scope.STATUSModule.STATUSListGrid.onRegisterApi = (gridApi) => {
                this.gridService.adjustGridHeight("STATUSListGrid", this.scope.STATUSModule.STATUSListGrid.data.length, 500);
                gridApi.core.on.renderingComplete(this.scope, (handler: any) => { this.gridService.restoreGridState("STATUSListGrid", gridApi); });
                gridApi.core.on.sortChanged(this.scope, (handler: any) => { this.gridService.saveGridState("STATUSListGrid", gridApi); });
                gridApi.core.on.columnVisibilityChanged(this.scope, (handler: any) => { this.gridService.saveGridState("STATUSListGrid", gridApi); });
                gridApi.core.on.filterChanged(this.scope, (handler: any) => { this.gridService.saveGridState("STATUSListGrid", gridApi); });
                gridApi.colMovable.on.columnPositionChanged(this.scope, (handler: any) => { this.gridService.saveGridState("STATUSListGrid", gridApi); });
                gridApi.colResizable.on.columnSizeChanged(this.scope, (handler: any) => { this.gridService.saveGridState("STATUSListGrid", gridApi); });
                ...
                gridApi.selection.on.rowSelectionChanged(this.scope, (row: any) => {
                    this.gridService.saveGridState("STATUSListGrid", gridApi);
                    this.STATUSListRowSelected(row);
                });
        ...
        */
        private loadApplicationData() {
            let categories = ['globalSelection', 'STATUSModule', 'customerMasterModule', 'STATUSModule'];
        ...
        private clearData(categories: string[]) {
            categories.forEach((category) => {
                ...
                if (category == "STATUSModule") {
                    ...
                    this.scope.STATUSModule.STATUSList = [];
                }
            });
        }
        ...
        */
        private refreshTransactionStatus() {
            ...
            switch (this.scope.activeModule) {
                case 1:
                    for (let transaction in this.scope.STATUSModule.transactionStatus) {
                        let value = this.scope.STATUSModule.transactionStatus[transaction];
                        if (value == true) {
                            isLoading = true;
                            break;
                        }
        ...
        */
        ...
        private loadSTATUSList(): void {
            ...
            this.scope.STATUSModule.STATUSRecord.PK03 = "";
            this.appService.lstSTATUSRecords().then((val: M3.IMIResponse) => {

                let filteredVal = this.filterSTATUS("CRZ009", val);
                this.scope.STATUSModule.STATUSList = filteredVal;
                this.scope.STATUSModule.STATUSListGrid.data = filteredVal;//val.items; //added after adding the list

                this.gridService.adjustGridHeight("STATUSListGrid", filteredVal.length, 1000) //added to adjust grid height
                this.scope.STATUSModule.transactionStatus.STATUSList = false;
                this.refreshTransactionStatus();
            }, (err: M3.IMIResponse) => {
                this.scope.STATUSModule.transactionStatus.STATUSList = false;
                this.refreshTransactionStatus();
        ...
        private filterSTATUS(fileName: string, val: M3.IMIResponse): any {
        ...
        private loadSTATUSRecord(fieldName: string, selectedRow): void {

            this.scope.loadingData = true;
            this.scope.STATUSModule.transactionStatus.STATUSRecord = true;
            this.appService.getSTATUSAlphaRecord(selectedRow.PK01, selectedRow.PK02, selectedRow.PK03, selectedRow.PK04).then((val: M3.IMIResponse) => {
                this.scope.STATUSModule.STATUSRecord = val.items[0];
            ...
            this.appService.getSTATUSNumericRecord(selectedRow.PK01, selectedRow.PK02, selectedRow.PK03, selectedRow.PK03).then((valNumeric: M3.IMIResponse) => {
                ...
                this.scope.STATUSModule.STATUSRecord.N096 = n096;
                this.scope.STATUSModule.STATUSRecord.N196 = n196;
                this.scope.STATUSModule.STATUSRecord.N396 = n396;
                this.scope.STATUSModule.STATUSRecord.N296 = parseInt(valNumeric.item.N296);
                this.scope.STATUSModule.STATUSRecord.N496 = parseInt(valNumeric.item.N496);
                this.scope.STATUSModule.STATUSRecord.N596 = parseInt(valNumeric.item.N596);
                this.scope.STATUSModule.STATUSRecord.N696 = parseInt(valNumeric.item.N696);
                this.scope.STATUSModule.STATUSRecord.N796 = parseInt(valNumeric.item.N796);
                this.scope.STATUSModule.STATUSRecord.N896 = parseInt(valNumeric.item.N896);
                this.scope.STATUSModule.STATUSRecord.N996 = parseInt(valNumeric.item.N996);
                this.scope.STATUSModule.transactionStatus.STATUSRecord = false;
                this.refreshTransactionStatus();
            }, (err: M3.IMIResponse) => {
        ...
        public saveSTATUSRecord(): void {

            // Needed keys
            let pk01 = this.scope.STATUSModule.STATUSRecord.PK01;
            let pk02 = this.scope.STATUSModule.STATUSRecord.PK02;
            let pk03 = this.scope.STATUSModule.STATUSRecord.PK03;
            let pk04 = this.scope.STATUSModule.STATUSRecord.PK04;

            // alpha fileds to save 
            let al30 = this.scope.STATUSModule.STATUSRecord.AL30;
            let al31 = this.scope.STATUSModule.STATUSRecord.AL31;
            if (al31 == "" || al31 == null) {
                al31 = al30;
            }
            al30 = al30.substring(0, 29);
            al31 = al31.substring(0, 14);
            let al32 = this.scope.STATUSModule.STATUSRecord.AL32;
            let al33 = this.scope.STATUSModule.STATUSRecord.AL33;
            let al34 = this.scope.STATUSModule.STATUSRecord.AL34;
            let al35 = this.scope.STATUSModule.STATUSRecord.AL35;
            let al36 = this.scope.STATUSModule.STATUSRecord.AL36;
            //NUMERIC
            let n096 = this.scope.STATUSModule.STATUSRecord.N096;
            let n196 = this.scope.STATUSModule.STATUSRecord.N196;
            let n296 = this.scope.STATUSModule.STATUSRecord.N296;
            let n396 = this.scope.STATUSModule.STATUSRecord.N396;
            let n496 = this.scope.STATUSModule.STATUSRecord.N496;
            let n596 = this.scope.STATUSModule.STATUSRecord.N596;
            let n696 = this.scope.STATUSModule.STATUSRecord.N696;
            let n796 = this.scope.STATUSModule.STATUSRecord.N796;
            let n896 = this.scope.STATUSModule.STATUSRecord.N896;
            let n996 = this.scope.STATUSModule.STATUSRecord.N996;
            ...
            if (this.isValid() === false) {
                ...
                this.appService.saveSTATUSAlphaRecord(pk01, pk02, pk03, pk04, al30, al31, al32, al33, al34, al35, al36).then((val: M3.IMIResponse) => {
                    this.appService.saveSTATUSNumericRecord(pk01, pk02, pk03, pk04, n096, n196, n296, n396, n496, n596, n696, n796, n896, n996).then((valNumerc: M3.IMIResponse) => {
     ...
     public displayDialog() {
            ...
            let r = confirm("Are you sure you want to delete " + this.scope.STATUSModule.STATUSRecord.PK01 +"?");
            if (r == true) {
                this.deleteRecord();
            }
        ...
        public addRecord(): void {
            ...
            //validation
            if (pk01 == "" || pk01 == null) {
                let error = "Status Code must be entered";
                this.showError(error, [error]);
            }
            else {

                this.appService.addSTATUSAlphaRecord(pk01, pk02, pk03, pk04, al30, al31, al32, al33, al34, al35, al36).then((val: M3.IMIResponse) => {

                    this.appService.addSTATUSNumeric(pk01, pk02, pk03, pk04, n096, n196, n296, n396, n496, n596, n696, n796, n896, n996).then((valNumerc: M3.IMIResponse) => {
                    ...
                    this.loadSTATUSList();
                    this.refreshTransactionStatus();
                    if (this.scope.STATUSModule.isMultipleAdd === false) {
                        this.closeModalWindow();
                        this.scope.STATUSModule.transactionStatus.STATUSRecord = false;
                    } else {
                        this.clearFileds();                        
        ...
        public deleteRecord(): void {
            this.scope.STATUSModule.transactionStatus.STATUSRecord = true;
            // Needed keys
            let pk01 = this.scope.STATUSModule.STATUSRecord.PK01;//constant

            let pk02 = this.scope.STATUSModule.STATUSRecord.PK02;
            let pk03 = this.scope.STATUSModule.STATUSRecord.PK03;
            let pk04 = this.scope.STATUSModule.STATUSRecord.PK04;
            this.appService.deleteSTATUSAlphaRecord(pk01, pk02, pk03, pk04).then((val: M3.IMIResponse) => {
                this.loadSTATUSList();
                this.closeModalWindow();
                this.scope.STATUSModule.transactionStatus.STATUSRecord = false;
                this.refreshTransactionStatus();
            ...
            //delete numeric
            this.appService.deleteSTATUSNumericRecord(pk01, pk02, pk03, pk04).then((val: M3.IMIResponse) => {
                this.loadSTATUSList();
                this.closeModalWindow();
                this.scope.STATUSModule.transactionStatus.STATUSRecord = false;
                this.refreshTransactionStatus();
        ...
        public openAddRecordwindow(): void {
            let stco = this.scope.STATUSModule.STATUSRecord.PK01;
            
            this.scope.STATUSModule.STATUSRecord.PK01 = stco;

            if (stco == "" || stco == null || stco == 0) {
                let error = "Constant must be entered";
        ...
        */
        private loadSTATUSModule(reLoad: boolean): void {
            let userContext = this.scope.userContext;
        ...
        private openSTATUSAddRecordModal(): void { //POPUP
            let options: any = {
                animation: true,
        ...
        private STATUSListRowSelected(selectedRow: any) {
