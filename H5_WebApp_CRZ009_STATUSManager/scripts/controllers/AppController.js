        ...
        var AppController = (function () {
            ...
            AppController.prototype.initAppScope = function () {
                ...
                this.scope.views = {
                    ...
                    STATUSModule: { url: "views/STATUSModule.html" },
                    errorModule: { url: "views/Error.html" },
                };
                this.scope.modules = [
                    { moduleId: 1, activeIcon: 'SampleModule1.png', inactiveIcon: 'SampleModule1-na.png', heading: 'Status Code Module', content: this.scope.views.STATUSModule.url, active: true, available: true },
                ];
                this.scope.appConfig = {};
                this.scope.userContext = new M3.UserContext();
                this.scope["dateRef"] = new Date();
                this.initGlobalSelection();
                this.initSTATUSModule();
            };
            AppController.prototype.initGlobalSelection = function () {
                this.scope.globalSelection = {
                    reload: true,
                    transactionStatus: {
                        STATUSTableList: false,
                    },
                    division: {},
                };
            };
            AppController.prototype.initSTATUSModule = function () {
                this.scope.STATUSModule = {
                    reload: true,
                    transactionStatus: {
                        STATUSList: false,
                        STATUSRecord: false,
                    ...
                    STATUSList: {},
                    STATUSListGrid: {},
                    selectedSTATUSListRow: {},
                    STATUSRecord: {},
                    loadSTATUSRecordModule: {},
                    isMultipleAdd: false
                };
                this.loadSTATUSList();
            };
            ...
            AppController.prototype.initScopeFunctions = function () {
                var _this = this;
                this.scope.STATUSModule.loadSTATUSRecordModule = function (fieldName, rowEntity) { _this.displayDetailScreen(fieldName, rowEntity); };
            };
            AppController.prototype.initUIGrids = function () {
                this.scope.STATUSModule.STATUSListGrid = this.gridService.getSTATUSListGrid();
                this.initUIGridsOnRegisterApi();
            };
            AppController.prototype.initUIGridsOnRegisterApi = function () {
                var _this = this;
                this.scope.STATUSModule.STATUSListGrid.onRegisterApi = function (gridApi) {
                    _this.gridService.adjustGridHeight("STATUSListGrid", _this.scope.STATUSModule.STATUSListGrid.data.length, 500);
                    gridApi.core.on.renderingComplete(_this.scope, function (handler) { _this.gridService.restoreGridState("STATUSListGrid", gridApi); });
                    gridApi.core.on.sortChanged(_this.scope, function (handler) { _this.gridService.saveGridState("STATUSListGrid", gridApi); });
                    gridApi.core.on.columnVisibilityChanged(_this.scope, function (handler) { _this.gridService.saveGridState("STATUSListGrid", gridApi); });
                    gridApi.core.on.filterChanged(_this.scope, function (handler) { _this.gridService.saveGridState("STATUSListGrid", gridApi); });
                    gridApi.colMovable.on.columnPositionChanged(_this.scope, function (handler) { _this.gridService.saveGridState("STATUSListGrid", gridApi); });
                    gridApi.colResizable.on.columnSizeChanged(_this.scope, function (handler) { _this.gridService.saveGridState("STATUSListGrid", gridApi); });
                    ...
                    gridApi.selection.on.rowSelectionChanged(_this.scope, function (row) {
                        _this.gridService.saveGridState("STATUSListGrid", gridApi);
                        _this.STATUSListRowSelected(row);
                    });
            ...
            AppController.prototype.closeModalWindow = function () {
                this.scope.STATUSModule.STATUSRecord.PK01 = "";
                this.scope.STATUSModule.STATUSRecord.PK02 = "";
                this.scope.STATUSModule.STATUSRecord.PK03 = "";
                this.scope.STATUSModule.STATUSRecord.PK04 = "";
            ...
            AppController.prototype.loadApplicationData = function () {
                var categories = ['globalSelection', 'STATUSModule', 'customerMasterModule', 'STATUSModule'];
            ...
            AppController.prototype.clearData = function (categories) {
                ...
                categories.forEach(function (category) {
                    ...
                    if (category == "STATUSModule") {
                        _this.scope.STATUSModule.STATUSList = [];
                    }
                });
            };
            AppController.prototype.resetReloadStatus = function () {
                this.scope.STATUSModule.reload = true;
            };
            ...
            AppController.prototype.loadData = function (activeModule) {
                ...
                switch (activeModule) {
                    case 1:
                        this.loadSTATUSModule(this.scope.STATUSModule.reload);
                        break;
                    case 2:
                        break;
                    case 3:
            ...
            AppController.prototype.refreshTransactionStatus = function () {
                ...
                switch (this.scope.activeModule) {
                    case 1:
                        for (var transaction in this.scope.STATUSModule.transactionStatus) {
                            var value = this.scope.STATUSModule.transactionStatus[transaction];
                            if (value == true) {
                                isLoading = true;
                                break;
                            }
            ...
            AppController.prototype.loadSTATUSList = function () {
                var _this = this;
                this.scope.loadingData = true;
                this.scope.STATUSModule.transactionStatus.STATUSList = true;
                this.scope.STATUSModule.STATUSRecord.PK03 = "";
                this.appService.lstSTATUSRecords().then(function (val) {
                    var filteredVal = _this.filterSTATUS("CRZ009", val);
                    _this.scope.STATUSModule.STATUSList = filteredVal;
                    _this.scope.STATUSModule.STATUSListGrid.data = filteredVal;
                    _this.gridService.adjustGridHeight("STATUSListGrid", filteredVal.length, 1000);
                    _this.scope.STATUSModule.transactionStatus.STATUSList = false;
                    _this.refreshTransactionStatus();
                }, function (err) {
                    _this.scope.STATUSModule.transactionStatus.STATUSList = false;
                    _this.refreshTransactionStatus();
            ...
            AppController.prototype.filterSTATUS = function (fileName, val) {
                var filteredValues = [];
            ...
            AppController.prototype.displayDetailScreen = function (fieldName, selectedRow) {
                this.loadSTATUSRecord(fieldName, selectedRow);
                this.openRecordDetailModal(fieldName, selectedRow);
            };
            AppController.prototype.loadSTATUSRecord = function (fieldName, selectedRow) {
                var _this = this;
                this.scope.loadingData = true;
                this.scope.STATUSModule.transactionStatus.STATUSRecord = true;
                this.appService.getSTATUSAlphaRecord(selectedRow.PK01, selectedRow.PK02, selectedRow.PK03, selectedRow.PK04).then(function (val) {
                    _this.scope.STATUSModule.STATUSRecord = val.items[0];
                    _this.scope.STATUSModule.transactionStatus.STATUSRecord = false;
                    _this.refreshTransactionStatus();
                }, function (err) {
                    _this.scope.STATUSModule.transactionStatus.STATUSRecord = false;
                    _this.refreshTransactionStatus();
                ...
                this.appService.getSTATUSNumericRecord(selectedRow.PK01, selectedRow.PK02, selectedRow.PK03, selectedRow.PK03).then(function (valNumeric) {
                    ...
                    _this.scope.STATUSModule.STATUSRecord.N096 = n096;
                    _this.scope.STATUSModule.STATUSRecord.N196 = n196;
                    _this.scope.STATUSModule.STATUSRecord.N396 = n396;
                    _this.scope.STATUSModule.STATUSRecord.N296 = parseInt(valNumeric.item.N296);
                    _this.scope.STATUSModule.STATUSRecord.N496 = parseInt(valNumeric.item.N496);
                    _this.scope.STATUSModule.STATUSRecord.N596 = parseInt(valNumeric.item.N596);
                    _this.scope.STATUSModule.STATUSRecord.N696 = parseInt(valNumeric.item.N696);
                    _this.scope.STATUSModule.STATUSRecord.N796 = parseInt(valNumeric.item.N796);
                    _this.scope.STATUSModule.STATUSRecord.N896 = parseInt(valNumeric.item.N896);
                    _this.scope.STATUSModule.STATUSRecord.N996 = parseInt(valNumeric.item.N996);
                    _this.scope.STATUSModule.transactionStatus.STATUSRecord = false;
                    _this.refreshTransactionStatus();
                }, function (err) {
                });
            };
            AppController.prototype.saveSTATUSRecord = function () {
                var _this = this;
                var pk01 = this.scope.STATUSModule.STATUSRecord.PK01;
                var pk02 = this.scope.STATUSModule.STATUSRecord.PK02;
                var pk03 = this.scope.STATUSModule.STATUSRecord.PK03;
                var pk04 = this.scope.STATUSModule.STATUSRecord.PK04;
                var al30 = this.scope.STATUSModule.STATUSRecord.AL30;
                var al31 = this.scope.STATUSModule.STATUSRecord.AL31;
                if (al31 == "" || al31 == null) {
                    al31 = al30;
                }
                al30 = al30.substring(0, 29);
                al31 = al31.substring(0, 14);
                var al32 = this.scope.STATUSModule.STATUSRecord.AL32;
                var al33 = this.scope.STATUSModule.STATUSRecord.AL33;
                var al34 = this.scope.STATUSModule.STATUSRecord.AL34;
                var al35 = this.scope.STATUSModule.STATUSRecord.AL35;
                var al36 = this.scope.STATUSModule.STATUSRecord.AL36;
                var n096 = this.scope.STATUSModule.STATUSRecord.N096;
                var n196 = this.scope.STATUSModule.STATUSRecord.N196;
                var n296 = this.scope.STATUSModule.STATUSRecord.N296;
                var n396 = this.scope.STATUSModule.STATUSRecord.N396;
                var n496 = this.scope.STATUSModule.STATUSRecord.N496;
                var n596 = this.scope.STATUSModule.STATUSRecord.N596;
                var n696 = this.scope.STATUSModule.STATUSRecord.N696;
                var n796 = this.scope.STATUSModule.STATUSRecord.N796;
                var n896 = this.scope.STATUSModule.STATUSRecord.N896;
                var n996 = this.scope.STATUSModule.STATUSRecord.N996;
                if (this.isValid() === false) {
                    var error = "Invalid";
                    this.showError(error, [error]);
                }
                else {
                    this.appService.saveSTATUSAlphaRecord(pk01, pk02, pk03, pk04, al30, al31, al32, al33, al34, al35, al36).then(function (val) {
                        _this.appService.saveSTATUSNumericRecord(pk01, pk02, pk03, pk04, n096, n196, n296, n396, n496, n596, n696, n796, n896, n996).then(function (valNumerc) {
                        }, function (err) {
                        });
                        _this.scope.STATUSModule.transactionStatus.STATUSRecord = false;
            ...
            AppController.prototype.myError = function (err) {
                this.scope.STATUSModule.transactionStatus.STATUSRecord = false;
                this.refreshTransactionStatus();
                var error = "API: " + err.program + "." + err.transaction + ", Input: " + JSON.stringify(err.requestData) + ", Error Code: " + err.errorCode;
            ...
            AppController.prototype.displayDialog = function () {
                var r = confirm("Are you sure you want to delete " + this.scope.STATUSModule.STATUSRecord.PK01 + "?");
                if (r == true) {
                    this.deleteRecord();
                }
            };
            AppController.prototype.addRecord = function () {
                ...
                var n996 = this.scope.STATUSModule.STATUSRecord.N996;
                if (pk01 == "" || pk01 == null) {
                    var error = "Status Code must be entered";
                    this.showError(error, [error]);
                }
                else {
                    this.appService.addSTATUSAlphaRecord(pk01, pk02, pk03, pk04, al30, al31, al32, al33, al34, al35, al36).then(function (val) {
                        _this.appService.addSTATUSNumeric(pk01, pk02, pk03, pk04, n096, n196, n296, n396, n496, n596, n696, n796, n896, n996).then(function (valNumerc) {
                        }, function (err) {
                        });
                        _this.loadSTATUSList();
                        _this.refreshTransactionStatus();
                        if (_this.scope.STATUSModule.isMultipleAdd === false) {
                            _this.closeModalWindow();
                            _this.scope.STATUSModule.transactionStatus.STATUSRecord = false;
                        }
                        else {
            ...
            AppController.prototype.deleteRecord = function () {
                ...
                var pk03 = this.scope.STATUSModule.STATUSRecord.PK03;
                var pk04 = this.scope.STATUSModule.STATUSRecord.PK04;
                this.appService.deleteSTATUSAlphaRecord(pk01, pk02, pk03, pk04).then(function (val) {
                    _this.loadSTATUSList();
                    _this.closeModalWindow();
                    _this.scope.STATUSModule.transactionStatus.STATUSRecord = false;
                    _this.refreshTransactionStatus();
                ...
                this.appService.deleteSTATUSNumericRecord(pk01, pk02, pk03, pk04).then(function (val) {
                    _this.loadSTATUSList();
                    _this.closeModalWindow();
                    _this.scope.STATUSModule.transactionStatus.STATUSRecord = false;
                    _this.refreshTransactionStatus();
            ...
            AppController.prototype.clearFileds = function () {
                this.scope.STATUSModule.STATUSRecord.KPID = "CRZ009";
                this.scope.STATUSModule.STATUSRecord.PK02 = this.scope.userContext.division;
                this.scope.STATUSModule.STATUSRecord.PK03 = "";
                this.scope.STATUSModule.STATUSRecord.PK04 = this.scope.userContext.language;
                this.scope.STATUSModule.STATUSRecord.AL30 = "";
                this.scope.STATUSModule.STATUSRecord.AL31 = "";
            };
            AppController.prototype.openAddRecordwindow = function () {
                var stco = this.scope.STATUSModule.STATUSRecord.PK01;
                this.scope.STATUSModule.STATUSRecord.PK01 = stco;
                if (stco == "" || stco == null || stco == 0) {
                    var error = "Constant must be entered";
                    this.showError("Constant", [error]);
                }
                else {
                    this.scope.STATUSModule.STATUSRecord.KPID = "CRZ009";
                    this.scope.STATUSModule.STATUSRecord.PK01 = stco;
                    ...
                    this.scope.STATUSModule.STATUSRecord.AL30 = "";
                    this.scope.STATUSModule.STATUSRecord.AL31 = "";
                    this.scope.STATUSModule.STATUSRecord.AL32 = "";
                    this.scope.STATUSModule.STATUSRecord.AL33 = "";
                    this.scope.STATUSModule.STATUSRecord.AL34 = "";
                    this.scope.STATUSModule.STATUSRecord.AL35 = "";
                    this.scope.STATUSModule.STATUSRecord.AL36 = "";
                    this.scope.STATUSModule.STATUSRecord.N096 = 0;
                    this.scope.STATUSModule.STATUSRecord.N196 = 0;
                    this.scope.STATUSModule.STATUSRecord.N296 = 0;
                    this.scope.STATUSModule.STATUSRecord.N396 = 0;
                    this.scope.STATUSModule.STATUSRecord.N496 = 0;
                    this.scope.STATUSModule.STATUSRecord.N596 = 0;
                    this.scope.STATUSModule.STATUSRecord.N696 = 0;
                    this.scope.STATUSModule.STATUSRecord.N796 = 0;
                    this.scope.STATUSModule.STATUSRecord.N896 = 0;
                    this.scope.STATUSModule.STATUSRecord.N996 = 0;
                    this.openSTATUSAddRecordModal();
                }
            };
            AppController.prototype.loadSTATUSModule = function (reLoad) {
                var userContext = this.scope.userContext;
                if (reLoad) {
                    this.clearData(["STATUSModule"]);
                    this.loadSTATUSList();
                }
                this.scope.STATUSModule.reload = false;
            };
            AppController.prototype.openRecordDetailModal = function (fieldName, rowEntity) {
                var options = {
                    animation: true,
                    templateUrl: "views/STATUSRecordDetail.html",
                    size: "lg",
                    scope: this.scope,
                    backdrop: "static"
                };
                this.scope.modalWindow = this.$uibModal.open(options);
                this.scope.STATUSModule.selectedSTATUSListRow = rowEntity;
            };
            AppController.prototype.openSTATUSAddRecordModal = function () {
                var options = {
                    animation: true,
                    templateUrl: "views/AddSTATUSRecordModal.html",
                    size: "lg",
                    scope: this.scope,
                    backdrop: "static"
                };
            ...
            AppController.prototype.STATUSListRowSelected = function (selectedRow) {
                this.scope.STATUSModule.selectedSTATUSListRow = selectedRow.entity;
            };
